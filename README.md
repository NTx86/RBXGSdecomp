...
You can create the [objdiff](https://github.com/encounter/objdiff) project by first exporting objects with the [Object file exporter extension for Ghidra](https://github.com/boricj/ghidra-delinker-extension) into a `RBXGS` directory in the root of this repository, then run `configure.py`.
